...
for url in urls:
    ...
    tmp_url = f"https://www.oes-cs.dk/bevillingslove/doctopic.cgi?book=BEVPUBL.FL{url}&topic=19.22.01&searchtype=3"
    ...
    virk_df.to_csv(f"virk_{url}.csv",index=False,sep=";")
    optag_df.to_csv(f"optag_{url}.csv",index=False,sep=";")
    aktivitet_df.to_csv(f"aktivitet_{url}.csv",index=False,sep=";")
